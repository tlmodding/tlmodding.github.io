...
:::tip[New editor available!]
A [web-based save editor](https://ltd-save-editor.pages.dev/) is now available! It makes editing your save file easier and more accessible!

Try it now on https://ltd-save-editor.pages.dev/
:::
...
Currently, you can use either the downloable Save Editor, *which will be covered on this page*, or the [web-based Save Editor](https://ltd-save-editor.pages.dev/), which have a more friendly user interface and can be used on any platform without the need of downloading anything.
