...
| `bl_Label`                | string   | Alias for how the item should be referenced. May be utilized in other attribute labels or in [MSBF](/documentation/file-formats/lms/msbf) node parameters |
